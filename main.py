...
def Frensh(message):
    ...
    button1_6 = types.KeyboardButton("البلدان")
...
@bot.message_handler(func=lambda message: message.text == "حرف جر à")
def a(message):
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True, one_time_keyboard=True)
